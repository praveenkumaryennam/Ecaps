	          	...
	          	<div class="col-md-6">
		            <table class="table table-bordered">
		                ...
		                foreach ($invoices as $i){ 
		                  $c = get_credit_amount($i->invoice_number);
		                  if(empty($c))
		                  	$c = 0;

		                  $ctotal += $c;

			              if(number_format(abs($i->invoice_total - $i->paid)) > 0){
		                ...
		                ?>
			                <tr>
			                  <td>
					            <input type="checkbox" name="client_invoice" class="sel_invoice" data-invoice="<?= $i->invoice_number;?>" data-amount="<?= abs($i->invoice_total - $i->paid);?>" />
			                  </td>
		                ...
		                <?php } }?>
		                	<tr>
			                  ...
			                  <td><b><?= number_format($ctotal, 2);?></b></td>
				            </tr>
	           	...
	           	<div class="col-md-6" id="blcshow">
		            <table class="table table-bordered">
		            	<tr>
		            		<th>Payment Date</th>
		            		<td><input id="pay_date" type="text" value="<?= date('d-m-Y')?>" class="form-control datepicker" placeholder="DD-MM-YYYY" /></td>
		            	</tr>
		            	<tr>
