        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <address style="text-align: right; font-size: 12px;">
              ...
              ?>
              <strong>Credit #.</strong> <?= $invoice[0]->cradit_no;?><br />
              <strong>Credit Date</strong> <?= date('d-m-Y', strtotime($invoice[0]->cradit_date));?><br />
              <strong>Invoice #.</strong> <?= $invoice[0]->invoice_number;?><br />
              <strong>Invoice Date</strong> <?= date('d-m-Y', strtotime($invoice[0]->invoice_date));?><br />
            </address>
          </div>
        </div>
        <div class="row">
                ...
                foreach($pros as $p){
                  if($p->order_id == $i->order_id){
                    ...
                    <td>&nbsp;'.$i->patiant.'</td>
                      ...
                      <td>&nbsp;'.$p->unit.'</td>
                      <td>&nbsp;<b>'.number_format($p->cradit_amt, 2).'</b></td>
