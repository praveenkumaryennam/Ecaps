          ...
          <tbody>
              ...
              foreach($invoice as $i){
                ...
                foreach($pros as $p){
                  if($p->order_id == $i->order_id){
                    ...
                    $th = explode(',', get_teeth($p->order_id, $p->product));
                    asort($th);
                    foreach ($th as $te){
                      if($te >= 11 && $te <= 18){
                        $p1[] = $a[$te];
                    ...
                    <td>&nbsp;'.$i->patiant.'</td>
                      ...
                      <td>
                        <table width="100%" border="1">
                          <tr>
                            <td width="50%" style="text-align:center;"><b>'.implode(',',$p1).'</b></td>
                            <td width="50%" style="text-align:center;"><b>'.implode(',',$p2).'</b></td>
                          </tr><tr>
                            <td width="50%" style="text-align:center;"><b>'.implode(',',$p3).'</b></td>
                            <td width="50%" style="text-align:center;"><b>'.implode(',',$p4).'</b></td>
                          </tr>
                        </table>
                      </td>
                      <td>&nbsp;'.$p->unit.'</td>
                      <td>&nbsp;<input type="text" id="unitprice'.$z.'" value="'.$p->unitprice.'" class="form-control unitprice" data-order="'.$i->order_number.'" data-units="'.$p->unit.'" data-id="'.$z.'"/></td>
            ...
            <tr>
              <td colspan="8" style="text-align:right">
                Remark : <input type="text" name="cremark" class="form-control" style="width: 100%" />
              </td>
        ...
        <div class="row">
          <div class="col-xs-4" style="margin-top:5%; line-height: 5px; font-size: 10px; font-weight: bold;">
            <table class="table table-bordered">
              <tr><td style="font-size: 8px; font-weight: bold">BANK NAMEt</td> <td style="font-size: 8px; font-weight: bold"> ICICI BANK</td></tr>
              <tr><td style="font-size: 8px; font-weight: bold">BRANCHt</td> <td style="font-size: 8px; font-weight: bold"> JOGESHWARI (E)</td></tr>
              <tr><td style="font-size: 8px; font-weight: bold">A/C NOt</td> <td style="font-size: 8px; font-weight: bold"> 123605001442</td></tr>
              <tr><td style="font-size: 8px; font-weight: bold">IFS CODEt</td> <td style="font-size: 8px; font-weight: bold"> ICICI0001236</td></tr>
            </table>
          </div>
    ...
    <script>
      ...
      $('.unitprice').change(function() {
        ...
        for(var k=1; k<=z; k++){
          ...
          $('#subtotal'+z).text(units * price);
          $('#subtotal').text(subtotal);
          newdata.push({order_no: order_no, units: units, price: price});
        }
      })
    </script>
  </body>
