              ...
              foreach($invoice as $i){
                ...
                foreach($pros as $p){
                  if($p->order_id == $i->order_id){
                    ...
                    <td>&nbsp;'.ucfirst(get_worktype($i->order_number)).'</td>
                    ...
                    <td>&nbsp;'.$i->patiant.'</td>
                      ...
                      <td>&nbsp;<b>'.number_format(str_replace(',', '', $p->subtotal), 2).'</b></td>
                    </tr>';
                    $tunits += $p->unit;
                  }
                }
            ...
            <tr>
              ...
              <th colspan='1'>
                <table border="1" width="100%">
                  ...
                  <?php } ?>
                  <tr><th width="50%">invoice Total </th></tr>
                </table>
              </th>
              <td colspan='3'>
                <table border="1" width="100%">
                  <tr><th colspan="3">&nbsp;<?= number_format(($i->discount), 2);?>./-</th></tr>
                  <?php if($i->invoice_gst_amount > 0) {?>
                    <tr>
                  ...
                  <?php } ?>
                  <tr><th colspan="3">&nbsp;<?= number_format(($i->invoice_total), 2);?>./-</th></tr>
                </table>
              </td>
            </tr>
          </tbody>
        ...
        <div class="row">
          <div class="col-xs-4" style="margin-top:5%; line-height: 5px; font-size: 10px; font-weight: bold;">
            <table class="table table-bordered">
              ...
              <tr><td style="font-size: 8px; font-weight: bold">IFSC CODE</td> <td style="font-size: 8px; font-weight: bold"> ICIC0001236</td></tr>
            </table>
          </div>
