  ...
  <div class="col-md-12">
    <div class="panel">
      <div class="box-header">
        ...
        <button class="btn btn-primary add addp" data-toggle="modal" data-target="#modal-default"><i class="fa fa-plus"></i> Select Product</button>
      </div>
        ...
        <form action="#" method="post" class="" autocomplete="off">
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <table class="table table-bordered mbt">
                <tr>
				<!-- <td>New <input type="radio" class="worktype" id="worktype" name="worktype" value="new" <?= ($order->work_type == "new")?'checked':'';?>/></td>
                  <td>Redo <input type="radio" class="worktype" id="worktype" name="worktype" value="redo" <?= ($order->work_type == "redo")?'checked':'';?>/></td>
                  <td>Correction <input type="radio" class="worktype" id="worktype" name="worktype" value="correction" <?= ($order->work_type == "correction")?'checked':'';?>/></td> -->
            ...
            <div class="col-md-4">
              <table class="table table-bordered mbt">
                    ...
                    <select id="priority" name="priority" class="form-control select2" style="width:100%;">
                      ...
                      <?php 
                          foreach (loadoption('priority') as $opt){
                            ...
                            echo '<option value=\''.$opt->id.'\' '.$sel.' data-days="'.$opt->days.'">'.ucfirst($opt->title).'</option>';
                          }
                      ?>
                    </select>
                  </td>
                ...
                <tr><td>Order Date</td><th width="300"><input type="text" id="orderdate" name="orderdate" class="form-control" value="<?= date('d-m-Y h:i a', strtotime($order->order_date));?>" readonly></th></tr>
                <tr>
                  <td>Due Date</td>
                  <th style="display: inline-flex">
                    <input type="text" id="duedate" name="duedate" class="form-control" value="<?= date('d-m-Y', strtotime($order->due_date));?>" style="width: 50%" readonly required> &nbsp;
                    <?php 
                      if(strlen($order->duetime) > 1){
                        echo '<input type="text" id="duetime" name="duetime" class="form-control" value="'.date('h:i A', strtotime($order->duetime)).'" style="width: 50%" required readonly>';
                      }else{
                    ?>
                ...
                <tr>
                  <td>In Date</td>
                  <th style="display: inline-flex">
                    <input type="text" id="indate" name="indate" class="form-control" value="<?= date('d-m-Y', strtotime($order->in_date));?>" style="width: 64%" readonly required> &nbsp;
                   <?php 
                      if(strlen($order->intime) > 1){
                        echo '<input type="text" id="intime" name="intime" class="form-control" value="'.date('h:i A', strtotime($order->intime)).'" style="width: 50%" required readonly>';
                      }else{
                    ?>
                ...
                <?php 
                    foreach (trails_process() as $k) {
                      echo '<tr>
                              ...
                              <input id="sstv'.$k['id'].'" type="hidden" class="form-control schedulesv" value="'.$k['id'].'" data-id="'.$k['id'].'" name="schedules[]">
                            </tr>';  
                    }
          ...
          <div class="row">
            <div class="col-md-12">
              <input type="button" class="btn btn-primary pull-right placeorder" value="Place Order" />
            </div>
          </div>
        </form>
      </div>
          ...
          <div class="col-md-3">
            ...
            <?php 
              if($order->work_type == 'new')
                echo '<input type="text" id="unit" name="unit" class="form-control" readonly="true">';
              else
                echo '<input type="text" id="unit" name="unit" class="form-control" />';
            ?>
          </div>
          <div class="col-md-3">
            ...
            <?php 
              if($order->work_type == 'new')
                echo '<input type="text" id="unitrate" name="unitrate" class="form-control" readonly="true"><input type="hidden" id="cdiscount" name="cdiscount" class="form-control" readonly="true">';
              else
                echo '<input type="text" id="unitrate" name="unitrate" class="form-control" /><input type="hidden" id="cdiscount" name="cdiscount" class="form-control" readonly="true">';
            ?>
          </div>
          <div class="col-md-3">
            <label>Total</label>
            <?php 
              if($order->work_type == 'new')
                echo '<input type="text" id="total" name="total" class="form-control" readonly="true">';
              else
                echo '<input type="text" id="total" name="total" class="form-control" />';
            ?>
          </div>
        </div>
        <div class="row">
