    ...
    <div class="row">
      <div class="col-xs-12 table-responsive">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            <?php $i = 0; foreach($pros as $pro){ ?>
              <tr>
                <td><?= ++$i;?></td>
                <td><?= get_title($pro['product'], 'product');?></td>
                <td><?= $pro['unit'];?></td>
                <td><?= number_format($pro['base_price'], 2);?></td>
                <td><?= number_format($pro['discount'], 2);?></td>
                <td>
                ...
                <td><?= number_format($pro['unitprice'], 2)?></td>
                <td><?= $pro['subtotal']?></td>
              </tr>
            <?php } ?>
          </tbody>
