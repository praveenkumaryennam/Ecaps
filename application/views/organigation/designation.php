                  ...
                  <?php
                    if(!empty($rows)){
                      ...
                      foreach($rows as $row){
                        ...
                        <td>'.$row->title.'</td>
                        <td>'.$row->code.'</td>
                        <td><a href="#"><i class="fa fa-trash btn btn-danger"></i></a> <a href="javascript:update('.$row->id.', \'designation\')"><i class="fa fa-edit btn btn-warning"></i></a></td>
                        </tr>';
                      }
                    }
                  ?>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group col-md-6">
                    ...
                    <input type="hidden" value="designation" name="master" class="form-control">
                </div>
                <div class="form-group col-md-6">
                    <label class="imp">Code</label>
                    <input type="text" name="code" readonly id="ecode" class="form-control">
                </div>
              </div>
            </div>
        </div>
